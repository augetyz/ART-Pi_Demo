...
extern osThreadId_t TCP_ServerHandle;
extern osThreadId_t TCP_ClientHandle;
extern osThreadId_t UDP_ServerHandle;
...
void DebugTask(void *argument)
{
    ...
    for(;;)
    {
        ...
        uint32_t stackFree = osThreadGetStackSpace(UDP_ServerHandle) / 1024;
