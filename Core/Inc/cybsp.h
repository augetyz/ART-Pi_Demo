...
*/
/*----------   -----------*/
#define CYBSP_BT_UART_CTS      PD11

/*----------   -----------*/
#define CY_WIFI_COUNTRY_CUSTOM      WHD_COUNTRY_XX

/*----------   -----------*/
#define CYBSP_BT_UART_TX      PB10
...
/*----------   -----------*/
#define CYBSP_WIFI_HOST_WAKE      PE3
...
/*----------   -----------*/
#define CYBSP_WIFI_WL_REG_ON      PC13

/*----------   -----------*/
#define CYBSP_BT_DEVICE_WAKE      PI10

/*----------   -----------*/
#define CYBSP_BT_HOST_WAKE      PC0
...
/*----------   -----------*/
#define CYBSP_BT_UART_RX      PB11

/*----------   -----------*/
#define CY_WIFI_COUNTRY      WHD_COUNTRY_UNITED_STATES

/*----------   -----------*/
#define CYBSP_BT_UART_RTS      PD12
